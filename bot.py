...
class RLGymExampleBot(BaseAgent):
    def __init__(self, name, team, index):
        ...
        self.ticks = 0
        self.prev_time = 0
        self.expected_teammates = 0 ## Hvis det er 1v1, og man spiller imod sin bot
    ...
    def reshape_state(self, gamestate):
        ## If teamsizes don't match up, this is used
        # replace me with code that handle
        pass
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        ticks_elapsed = round(delta * 120) ## Impossibum bruger = self.ticks*120
        ...
        if self.update_action:
            ...
            if len(opponents) == 0:
                ...
                self.game_state.players = [player] ### Denne stod i forvejen, men er nu ændret til impos:
                ## self.reshape_state(self.game_state) ### Imposs løsning
            else:
