...
class AerialKOState(StateSetter):
    ...
    def reset(self, state_wrapper: StateWrapper):
        ...
        self.reset_ball_random(state_wrapper)

    def reset_ball_random(self, state_wrapper: StateWrapper):
        """
        ...
        """
        state_wrapper.ball.set_pos(rand.random() * X_MAX - X_MAX/2, rand.random() * Y_MAX - Y_MAX/2, # Semirandom x og y
                                   rand.random() * (Z_MAX_BALL - MIN_HEIGHT) + 100 + MIN_HEIGHT) # Random højde, min 800
        state_wrapper.ball.set_lin_vel(*rand_vec3(1000)) ## fart på bolden (3000 udgangspunkt)
